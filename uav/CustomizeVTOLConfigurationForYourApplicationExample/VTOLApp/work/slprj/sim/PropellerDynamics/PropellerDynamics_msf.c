...
#define S_FUNCTION_NAME PropellerDynamics_msf
#endif
...
struct_DAy4VMOKMUhj3u1IcOvsOG rtP_uavParam ; real_T rtP_minPWM ; const char *
...
struct_DAy4VMOKMUhj3u1IcOvsOG * GlobalPrm_0 = ( struct_DAy4VMOKMUhj3u1IcOvsOG
* ) NULL ; real_T * GlobalPrm_1 = ( real_T * ) NULL ; if ( !
ssGetModelRefGlobalParamData ( S , 0 , ( void * * ) ( & GlobalPrm_0 ) ) )
return ; if ( GlobalPrm_0 != NULL ) { ( void ) memcpy ( & ( rtP_uavParam ) ,
GlobalPrm_0 , sizeof ( struct_DAy4VMOKMUhj3u1IcOvsOG ) ) ; } if ( !
ssGetModelRefGlobalParamData ( S , 1 , ( void * * ) ( & GlobalPrm_1 ) ) )
return ; if ( GlobalPrm_1 != NULL ) { ( void ) memcpy ( & ( rtP_minPWM ) ,
GlobalPrm_1 , sizeof ( real_T ) ) ; } }
#endif
static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) {
bfxsfyeisx3 * dw = ( bfxsfyeisx3 * ) ssGetDWork ( S , 0 ) ; real_T const *
i_i_oq5pqzhxbn = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T const *
i_o3zq1okhdu = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T const *
i_bgx2bw1fle = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T const *
i_ais0to0lrl = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T const *
i_lcc5ia3uhg = ( real_T * ) ssGetInputPortSignal ( S , 4 ) ; real_T const *
i_aydeqqjdgr = ( real_T * ) ssGetInputPortSignal ( S , 5 ) ; real_T * o_B_1_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_1_2 = ( real_T
* ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_1_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; if ( tid == 0 ) { PropellerDynamics ( & (
dw -> rtm ) , i_i_oq5pqzhxbn , i_o3zq1okhdu , i_bgx2bw1fle , i_ais0to0lrl ,
i_lcc5ia3uhg , i_aydeqqjdgr , o_B_1_1 , o_B_1_2 , o_B_1_3 , & ( dw -> rtb ) ,
...
, 0.0 ) ; if ( ! ssSetInputPortMatrixDimensions ( S , 3 , 3 , 1 ) ) return ;
...
, 0.0 ) ; if ( ! ssSetInputPortVectorDimension ( S , 4 , 3 ) ) return ;
...
, 0.0 ) ; if ( ! ssSetInputPortMatrixDimensions ( S , 5 , 3 , 1 ) ) return ;
...
mr_PropellerDynamics_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S
...
mr_PropellerDynamics_MdlInfoRegFcn ( S , "PropellerDynamics" , & retVal ) ;
if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( bfxsfyeisx3 ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { bfxsfyeisx3 * dw = (
bfxsfyeisx3 * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } j3unvwpf2g
...
-> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { bfxsfyeisx3 * dw = ( bfxsfyeisx3 * )
ssGetDWork ( S , 0 ) ; mdlProcessParameters ( S ) ; owx3smczj2 ( & ( dw ->
...
PropellerDynamicsTID1 ( & ( dw -> rtb ) ) ; } if ( tid != CONSTANT_TID && tid
!= PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 , tid ) ||
ssIsMinorTimeStep ( S ) ) { PropellerDynamics ( & ( dw -> rtm ) ,
i_i_oq5pqzhxbn , i_o3zq1okhdu , i_bgx2bw1fle , i_ais0to0lrl , i_lcc5ia3uhg ,
i_aydeqqjdgr , o_B_1_1 , o_B_1_2 , o_B_1_3 , & ( dw -> rtb ) , & ( dw -> rtdw
) ) ; } } }
#define MDL_ZERO_CROSSINGS
static void mdlZeroCrossings ( SimStruct * S ) { bfxsfyeisx3 * dw = (
bfxsfyeisx3 * ) ssGetDWork ( S , 0 ) ; real_T const * i_i_oq5pqzhxbn = (
real_T * ) ssGetInputPortSignal ( S , 0 ) ; h1jo3kaarc * localZCSV = (
h1jo3kaarc * ) ssGetNonsampledZCs ( S ) ; hgebfhb0qf ( i_i_oq5pqzhxbn ,
localZCSV ) ; } static void mdlTerminate ( SimStruct * S ) { bfxsfyeisx3 * dw
= ( bfxsfyeisx3 * ) ssGetDWork ( S , 0 ) ; ctvtngd0gv ( & ( dw -> rtm ) ) ;
return ; }
...
mdlrefDW = mr_PropellerDynamics_GetDWork ( ssGetDWork ( S , 0 ) ) ;
mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } { mxArray * data =
mr_PropellerDynamics_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber (
...
mr_PropellerDynamics_SetDWork ( ssGetDWork ( S , 0 ) , mxGetFieldByNumber (
