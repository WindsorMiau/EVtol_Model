...
## Generated on : Thu Jul 04 17:40:53 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PropellerDynamics_msf.mexw64
...
MODELREF_LINK_RSPFILE     = PropellerDynamics_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PropellerDynamics_msf.mexw64
...
SRCS = $(START_DIR)/slprj/sim/PropellerDynamics/PropellerDynamics_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = PropellerDynamics_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = D:/WindsorMiau_Office/MASTER_PERIOD/Project_Mobius/Project_Mobius/uav/CustomizeVTOLConfigurationForYourApplicationExample/VTOLApp/work/slprj/sim/PropellerDynamics/PropellerDynamicslib.lib
...
PropellerDynamics_msf.obj : $(START_DIR)/slprj/sim/PropellerDynamics/PropellerDynamics_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
