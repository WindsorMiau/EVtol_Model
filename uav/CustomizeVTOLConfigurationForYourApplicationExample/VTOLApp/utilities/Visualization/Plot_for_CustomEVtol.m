...
if plotfigure.Rotors == 1
    figure('Name','RPM');
    rotor1 = 60.*out.Result_Rotor(time_start:mission_list(end,3),1);
    rotor2 = 60.*out.Result_Rotor(time_start:mission_list(end,3),2);
    rotor3 = 60.*out.Result_Rotor(time_start:mission_list(end,3),3);
    rotor4 = 60.*out.Result_Rotor(time_start:mission_list(end,3),4);
    ...
    tilt1 = rad2deg(out.Result_Rotor(time_start:mission_list(end,3),5));
    tilt2 = rad2deg(out.Result_Rotor(time_start:mission_list(end,3),6));
...
if plotfigure.controlsurface == 1
    ...
    aileron = rad2deg(out.Result_CtrlSurfaces(time_start:mission_list(end,3),2));
    elevator = rad2deg(out.Result_CtrlSurfaces(time_start:mission_list(end,3),1));
    rudder = rad2deg(out.Result_CtrlSurfaces(time_start:mission_list(end,3),3));
